...
ARG AIRFLOW_EXTRAS="mongo,async,celery,cncf.kubernetes,dask,docker,elasticsearch,ftp,grpc,hashicorp,http,ldap,mysql,odbc,pandas,postgres,redis,sendgrid,sftp,slack,ssh,statsd,virtualenv"
